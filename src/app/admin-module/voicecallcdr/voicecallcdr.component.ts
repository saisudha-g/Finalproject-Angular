...
@Component({
  selector: 'app-voicecallcdr',
  templateUrl: './voicecallcdr.component.html',
  styleUrls: ['./voicecallcdr.component.css']
})
export class VoicecallcdrComponent implements OnInit {
  voicecdr: FormGroup;
...
dtoptions: DataTables.Settings = {};
  ...
  generateCDRs() {
    console.log("hi")
    const n = this.voicecdr.get('n')?.value;
    console.log(n);
    // this.service.getcdr(n).subscribe((pro)=>{this.productlist=pro});
    this.searchlist = this.service.getcdr(n).subscribe((e: any) => {
      if (Array.isArray(e)) {
        console.log(e);
        this.searchlist = e;
