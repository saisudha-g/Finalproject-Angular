...
@Component({
  selector: 'app-tollfreecdr',
  templateUrl: './tollfreecdr.component.html',
  styleUrls: ['./tollfreecdr.component.css']
})
export class TollfreecdrComponent {
  tollcdr:FormGroup;
...
dtoptions: DataTables.Settings = {};
  ...
  generateCDRs(){
    console.log("hi")
    const n=this.tollcdr.get('n')?.value;
    console.log(n);
    // this.service.getcdr(n).subscribe((pro)=>{this.productlist=pro});
    this.searchlist=this.service.gettollcdr(n).subscribe((e: any)=>{if(Array.isArray(e))
      {
        console.log(e);
        this.searchlist=e;
