...
@Component({
  selector: 'app-voipcdr',
  templateUrl: './voipcdr.component.html',
  styleUrls: ['./voipcdr.component.css']
})
...
dtoptions: DataTables.Settings = {};
  ...
  generateCDRs(){
    console.log("hi")
    const n=this.voipcdr.get('n')?.value;
    console.log(n);
    // this.service.getcdr(n).subscribe((pro)=>{this.productlist=pro});
    this.searchlist=this.service.getvoipcdr(n).subscribe((e: any)=>{if(Array.isArray(e))
      {
        console.log(e);
        this.searchlist=e;
