...
@Component({
  selector: 'app-voipconcdr',
  templateUrl: './voipconcdr.component.html',
  styleUrls: ['./voipconcdr.component.css']
})
export class VoipconcdrComponent {
  voipconcdr:FormGroup;
...
dtoptions: DataTables.Settings = {};
  ...
  generateCDRs(){
    console.log("hi")
    const n=this.voipconcdr.get('n')?.value;
    console.log(n);
    // this.service.getcdr(n).subscribe((pro)=>{this.productlist=pro});
    this.searchlist=this.service.getvoipconcdr(n).subscribe((e: any)=>{if(Array.isArray(e))
      {
        console.log(e);
        this.searchlist=e;
