...
@Component({
  selector: 'app-mmscdr',
  templateUrl: './mmscdr.component.html',
  styleUrls: ['./mmscdr.component.css']
})
...
dtoptions: DataTables.Settings = {};
  ...
  generateCDRs(){
    console.log("hi")
    const n=this.mmscdr.get('n')?.value;
    console.log(n);
    // this.service.getcdr(n).subscribe((pro)=>{this.productlist=pro});
    this.searchlist=this.service.getmmscdr(n).subscribe((e: any)=>{if(Array.isArray(e))
      {
        console.log(e);
        this.searchlist=e;
