...
@Component({
  selector: 'app-roamingcdr',
  templateUrl: './roamingcdr.component.html',
  styleUrls: ['./roamingcdr.component.css']
})
export class RoamingcdrComponent {
  roamingcdr:FormGroup;
...
dtoptions: DataTables.Settings = {};
  ...
  generateCDRs(){
    console.log("hi")
    const n=this.roamingcdr.get('n')?.value;
    console.log(n);
    // this.service.getcdr(n).subscribe((pro)=>{this.productlist=pro});
    this.searchlist=this.service.getroamingcdr(n).subscribe((e: any)=>{if(Array.isArray(e))
      {
        console.log(e);
        this.searchlist=e;
